...
part of 'lang_profile_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PharmacyProfileModel _$PharmacyProfileModelFromJson(
...
Map<String, dynamic> _$PharmacyProfileModelToJson(
        PharmacyProfileModel instance) =>
    <String, dynamic>{
...
PharmacyProfileData _$PharmacyProfileDataFromJson(Map<String, dynamic> json) =>
    PharmacyProfileData(
      info: json['info'] == null
          ? null
...
Map<String, dynamic> _$PharmacyProfileDataToJson(
        PharmacyProfileData instance) =>
    <String, dynamic>{
...
InfoData _$InfoDataFromJson(Map<String, dynamic> json) => InfoData(
      ...
      has_night_shifts: json['has_night_shifts'] as int?,
      logo_path: json['logo_path'] as String?,
      geolocation: json['geolocation'] as String?,
      ar: json['ar'] == null
          ? null
          : ArData.fromJson(json['ar'] as Map<String, dynamic>),
      en: json['en'] == null
          ? null
          : EnData.fromJson(json['en'] as Map<String, dynamic>),
      country_id: json['country_id'] as int?,
      country: json['country'] as String?,
      state_id: json['state_id'] as int?,
      state: json['state'] as String?,
      ...
      socialNetworks: (json['socialNetworks'] as List<dynamic>?)
        ...
        ? null
        : DeData.fromJson(json['de'] as Map<String, dynamic>);

Map<String, dynamic> _$InfoDataToJson(InfoData instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'has_night_shifts': instance.has_night_shifts,
...
EnData _$EnDataFromJson(Map<String, dynamic> json) => EnData(
      name: json['name'] as String?,
    );

Map<String, dynamic> _$EnDataToJson(EnData instance) => <String, dynamic>{
      'name': instance.name,
    };

DeData _$DeDataFromJson(Map<String, dynamic> json) => DeData(
      name: json['name'] as String?,
    );

Map<String, dynamic> _$DeDataToJson(DeData instance) => <String, dynamic>{
      'name': instance.name,
    };
