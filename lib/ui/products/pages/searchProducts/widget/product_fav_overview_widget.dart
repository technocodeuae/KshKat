...
import '../../productDetails/argument/ProductDetailsArgument.dart';
...
class ProductFavOverviewWidget extends StatefulWidget {
  ...
  @override
  ProductFavOverviewWidgetState createState() => ProductFavOverviewWidgetState();
}
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              ...
              {
                productsController.deleteFav(widget.cancelToken, widget.infoData!.id!);
                setState(() {
                  widget.infoData!.is_Fav =false;
                });
              }else
              {
                productsController.addFav(widget.cancelToken, widget.infoData!.id!);
                setState(() {
