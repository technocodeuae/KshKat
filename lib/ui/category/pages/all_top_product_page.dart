...
class AllTopProductPage extends StatefulWidget {
  // final token;
  final UserSignInDashboardResult? userInfo;

  const AllTopProductPage({this.userInfo});

  @override
  _AllTopProductPageState createState() => _AllTopProductPageState();
}

class _AllTopProductPageState extends State<AllTopProductPage>
    with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  CategoryController categoryController = Get.find();

  var _cancelToken = CancelToken();
  int limit = 25, page = 1, startAt = 0, endAt = 0, preparePage = 1;
  late List<LatestProductData> topList = <LatestProductData>[];
    ...
    return GetBuilder<CategoryController>(
        ...
        builder: (state) {
          ...
          if (state.topProductSuccess != null &&
            ...
            if (page == 1) {
              topList = state.topProductSuccess!.result.data!;
            } else {
              topList.addAll(state.topProductSuccess!.result.data!);
            }
