...
class LatestProductPage extends StatefulWidget {
  final token;
  final UserSignInDashboardResult? userInfo;

  const LatestProductPage({required this.token, this.userInfo});

  @override
  _LatestProductPageState createState() => _LatestProductPageState();
}

class _LatestProductPageState extends State<LatestProductPage>
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              height: 200.sp,
              child: ListView.builder(
                itemCount: 5, //latestList.length + 1,
                shrinkWrap: true,
                ...
                itemBuilder: (BuildContext context, int index) {
                  if (index == 4) {
                    return GestureDetector(
                      onTap: () {
                        print("shouldddddddddddddddd naivgateeeeeeeeee");
                        Navigator.of(context).pushNamed(
                            Routes.allLatestProductPage,
                            arguments:
                                GlobalArgument(token, null, null, null, null));

                        // navigate to latest product  screen
                      },
                      child: Padding(
